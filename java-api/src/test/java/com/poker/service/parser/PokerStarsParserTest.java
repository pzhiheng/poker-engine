...
class PokerStarsParserTest {
    ...
    void parseStake_playMoney_returnsInteger() {
        assertThat(PokerStarsParser.parseStake("15")).isEqualTo(15);
        assertThat(PokerStarsParser.parseStake("30")).isEqualTo(30);
    }

    @Test
    void parseStake_realMoney_convertsToCents() {
        assertThat(PokerStarsParser.parseStake("0.01")).isEqualTo(1);
        assertThat(PokerStarsParser.parseStake("0.50")).isEqualTo(50);
        assertThat(PokerStarsParser.parseStake("$0.25")).isEqualTo(25);
    }
}
